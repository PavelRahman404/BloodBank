...

{
    ...
    {
        private BloodBankExamEntities db = new BloodBankExamEntities();
        ...
        public ActionResult Create([Bind(Include = "GroupID,BloodType,Status")] BloodGroup bloodGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GroupID,BloodType,Status")] BloodGroup bloodGroup)
        {
            if (ModelState.IsValid)
            {
